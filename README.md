...
- 고정 원본: `https://raw.githubusercontent.com/guinnessNet/dry-syrup-calculator/v1.0.0/START-HERE.md`

`sources/dry-v1.0.0.md`는 고정 원본의 복제본이다.

- 바이트: `10272`
- SHA-256: `2158f26961f9e9266fec449f39e1ed3500458f9af59a9b24d957e968602505bb`
...
5. 검증 스크립트의 바이트와 SHA-256을 새 원본 값으로 바꾼다.
