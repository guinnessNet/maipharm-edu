...
const source = readFileSync(new URL('../sources/dry-v1.0.0.md', import.meta.url), 'utf8');
...
<head>
  ...
  <title>건조시럽 계산기 제작 지침 v1.0.0 | 마이팜 교육자료</title>
...
<body><main>
  ...
  <div class="meta"><strong>고정 버전 v1.0.0</strong><br>실제 조제 전 최신 허가사항과 제품 표시를 다시 확인하십시오.<br><a href="${canonical}">고정 원본 보기</a></div>
